    ...
    <AccordionContainer sx={{fontFamily: 'Roboto'}} elevation="12" id="specialties" aria-label="EMDR and Perinatal Mood and Anxiety Disorder">
      ...
      <Accordion expanded={expanded === 'panel1'} onChange={handleChange('panel1')}>
        <AccordionSummary aria-controls="panel1d-content" id="panel1d-header">
          {mobile && <Typography  >EMDR</Typography>}
          {desktop &&<Typography variant="h6">EMDR</Typography>}
        </AccordionSummary>
        <AccordionDetails>
          {mobile &&
          ...
          {desktop &&
            ...
            <br/>
          {mobile &&
            <Typography sx={{ fontSize:'1rem'}}>EMDR IS NOT TALK THERAPY! EMDR (Eye Movement Desensitization and Reprocessing) is a 
          ...
          {desktop &&
            ...
            <br/>
          {mobile &&
            <Typography sx={{ fontSize: '1rem'}}>EMDR is effective in decreasing anxiety and targeting negative or irrational thinking, both of which may get in the 
          ...
          {desktop &&
            <Typography variant="h6">
              EMDR is effective in decreasing anxiety and targeting negative or irrational thinking, both of which may get in the 
              way of performance. EMDR can help a person to gain confidence in their ability to perform a task or reach a goal. EMDR 
              installs positive beliefs, while simultaneously decreasing fear, anxiety, or stress. EMDR boosts confidence and helps the 
              brain to think in a healthier, more adaptive way by removing blocks (such as negative self-beliefs) and helping the person 
              to tap intothe treatment of the following:
      ...
      <Accordion expanded={expanded === 'panel2'} onChange={handleChange('panel2')} >
        <AccordionSummary aria-controls="panel2d-content" id="panel2d-header">
          {mobile && <Typography  >Perinatal Mood and Anxiety Disorder</Typography>}
          {desktop &&
            <Typography variant="h6" aria-label="Perinatal Mood and Anxiety Disorder">Perinatal Mood and Anxiety Disorder</Typography>}
        </AccordionSummary>
        <AccordionDetails>
          {mobile &&
            <Typography variant="h6">What is Perinatal Mood and Anxiety Disorder?</Typography>}
          {desktop &&
